...
"""
Global variable for the distance between the robot and the wall
"""

linear =0.5

"""
Global variable for the linear velocity of the robot
"""

angular=0.0

"""
Global variable for the angular velocity of the robot
"""
